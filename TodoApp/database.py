...
#SQLALCHEMY_DATABASE_URL = 'sqlite:///./todosapp.db' # for sqllite3 db for local use
# SQLALCHEMY_DATABASE_URL = 'postgresql://postgres:ztlab112@localhost/TodoApplicationDataBase' # for postgres db connection
